...
#	LOG "Checking for $QTYPE $QNAME"
	...
	echo "SIG_TYPE;RECORD;Q_TYPE;SIG_TYPE;SIG_ALG;SIG_NLAB;SIG_TTL;SIG_FROM;SIG_TIME_LEFT_SECS;SIG_TIME_LEFT_HR;SIG_UNTIL;SIG_TIME_ACTIVE_SECS;SIG_TIME_ACTIVE_HR;SIG_KEYID;SIG_OWNER;SIG_SIGNATURE"
	...
	while read 	RECORD \
		...
		do
			if [[ "$Q_TYPE" = "NSEC3" ]]
				then
					echo          ";$RECORD;$Q_TYPE;$SIG_TYPE;$SIG_ALG;$SIG_NLAB;$SIG_TTL;$SIG_FROM;;;$SIG_UNTIL;;;$SIG_KEYID;$SIG_OWNER;$SIG_SIGNATURE $_REST"
				else
					...
					echo "$SIG_TYPE;$RECORD;$Q_TYPE;$SIG_TYPE;$SIG_ALG;$SIG_NLAB;$SIG_TTL;$SIG_FROM;$SIG_TIME_LEFT;$SIG_TIME_LEFT_HR;$SIG_UNTIL;$SIG_TIME_ACTIVE;$SIG_TIME_ACTIVE_HR;$SIG_KEYID;$SIG_OWNER;$SIG_SIGNATURE $_REST"
				fi
		done < <(cat | grep RRSIG )
}
